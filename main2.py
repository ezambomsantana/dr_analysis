...
for x in range(0,21):
    file1 = 'scenario5/volume' + str(x) + '/events.xml'
    events = pd.read_csv(file1, sep = ';', header=None, names=['real_hour', 'real_minute', 'time','car', 'final_link', 'total_time','total_distance'])
    data5.append([x * 5, events['total_time'].mean(), events['total_time'].std()/8])    

    events_dr = events[events['car'].str.contains("dr")] 
    events_non_dr = events[~events['car'].str.contains("dr")] 
    
    data_dr5.append([x * 5, events_dr['total_time'].mean(), events_dr['total_time'].std()/8])
    data_non_dr5.append([x * 5, events_non_dr['total_time'].mean(), events_non_dr['total_time'].std()/8])
...
df5 = pd.DataFrame(data5, columns = ['scenario', 'mean_travel', 'std_travel']) 
...
df5 = pd.DataFrame(data_dr5, columns = ['scenario', 'mean_travel', 'std_travel']) 
...
df4 = pd.DataFrame(data_non_dr4, columns = ['scenario', 'mean_travel', 'std_travel']) 
df5 = pd.DataFrame(data_non_dr5, columns = ['scenario', 'mean_travel', 'std_travel']) 
